...
PREDICTOR_PATH = "extras/dlib/shape_predictor_68_face_landmarks.dat"
THRESHOLD_FACE_WIDTH = 200  # Minimum face width


class FeaturesDlib(object):
    def __init__(self, predictor_path=PREDICTOR_PATH, scale_factor=0.5 ):
        self.scale_factor = scale_factor  # downsample image on hog face detector
        self.detector = dlib.get_frontal_face_detector()
        self.predictor = dlib.shape_predictor(predictor_path)


    def extract_features(self, img, threshold_face_width=THRESHOLD_FACE_WIDTH):
        retval = None

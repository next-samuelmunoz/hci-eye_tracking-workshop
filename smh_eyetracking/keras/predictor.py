...
from ..features02 import config as config_features02
from ..features02.utils.features02_dlib import dlib2features, extract_eye, FEATURES
from ..features02.utils.normalize import normalize_features02
...
class Predictor:
    ...
    def __init__(self,
        ...
        self.dlib_model = FeaturesDlib()  # Face landmarks
